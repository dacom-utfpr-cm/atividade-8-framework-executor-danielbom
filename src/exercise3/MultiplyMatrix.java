...
public class MultiplyMatrix implements Runnable {
	...
	this(nThread, matrixA, matrixB, MultiplyMatrix.createResultMatrix(matrixA, matrixB));
    }
    
    public MultiplyMatrix(int nThreads, double[][] matrixA, double[][] matrixB, double[][] result) {
    ...
    public static double[][] createResultMatrix(double[][] matrixA, double[][] matrixB) {
